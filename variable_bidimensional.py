...
def variable_bivariada(Id,gc,nombre_variable1,nombre_variable2):
    ...
    print(f"El total de los estudiantes que hacen una maestría son {carrera_feminas_Msc + carrera_feminas_Msc} que representa el {(porcentaje_carrera_masculinos_Msc_RT + porcentaje_carrera_feminas_Msc_RT) * 100}%")
